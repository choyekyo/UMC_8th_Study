					...
					return (
                        <div key={comment.id} className="relative flex items-start gap-2">
                            ...
                            <div className="flex flex-col items-start ml-2 w-full">
                                <span className="font-semibold">{comment.author?.name ?? "알 수 없음"}</span>
                                    ...
                                    <>
                                        ...
                                        <div className="flex gap-2 mt-1">
                                            <button
                                                ...
                                                className="bg-pink-500 text-white px-2 py-1 rounded text-sm cursor-pointer"
                                            >
                                                저장
                                            </button>
                                            <button
                                                onClick={() => setEditingCommentId(null)}
                                                className="bg-gray-600 text-white px-2 py-1 rounded text-sm cursor-pointer"
                                            >
                                                취소
                                            </button>
                                        </div>
                                ...
                                {isMine && editingCommentId !== comment.id && (
                                    <div className="absolute right-0 top-0 flex gap-2">
                                        <button
                                            ...
                                            className="bg-pink-500 w-10 h-5 rounded-sm text-xs cursor-pointer"
                                        >
                                            수정
                                        </button>
                                        <button
