            ...
            <div className="flex flex-col gap-3">
                ...
                {step === 1 && (
                    <>
                        ...
                        <button type="button" onClick={handleNext} disabled={!!errors.email} className="w-full bg-pink-500 text-white py-3 rounded-md text-lg font-bold hover:bg-pink-700 disabled:bg-gray-700 cursor-pointer">다음</button>
                    </>
                )}
                ...
                {step === 2 && (
                    ...
                    <div className="text-white text-sm mb-1">
                        ...
                        <div className="relative w-[300px]">
                            ...
                            <button type="button" onClick={() => setShowPassword(!showPassword)} className="absolute top-1/2 right-2 transform -translate-y-1/2 w-5 h-5 cursor-pointer">{showPassword ? <IoEyeOutline className="text-white" /> : <IoEyeOffOutline className="text-white"/>}</button>
                        </div>
                        ...
                        <div className="relative w-[300px]">
                            ...
                            <button type="button" onClick={() => setShowPasswordCheck(!showPasswordCheck)} className="absolute top-1/2 right-2 transform -translate-y-1/2 w-5 h-5 cursor-pointer">{showPasswordCheck ? <IoEyeOutline className="text-white"/> : <IoEyeOffOutline className="text-white"/>}</button>
                        </div>

                        {errors.passwordCheck && (<div className="text-red-500 text-sm">{errors.passwordCheck.message}</div>)}
                        <button type="button"  disabled={!!errors.password || !!errors.passwordCheck} onClick={handleNext} className="w-full bg-pink-500 text-white py-3 rounded-md text-lg font-bold hover:bg-pink-700 disabled:bg-gray-700 cursor-pointer">다음</button>
                    </>
                )}
                ...
                {step === 3 && (
                    <>
                        ...
                        <button type="button" onClick={handleSubmit(onSubmit)} disabled={isSubmitting} className="w-full bg-pink-500 text-white py-3 rounded-md text-lg font-bold hover:bg-pink-700 transition-colors disabled:bg-gray-700 cursor-pointer">회원가입 완료</button>
                    </>
                )}
            </div>
        </div>
